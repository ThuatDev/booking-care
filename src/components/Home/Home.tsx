    ...
    <div className='mx-auto w-4/5'>
      ...
      <div className='py-5'>
        <p className=' pt-4 pb-2'>
          ...
          loạn lo âu – trầm cảm - stress khá phổ biến hiện nay trong cộng đồng. Bài test này thường&nbsp;được sử dụng để
          đánh giá tình trạng tâm lý của những người gặp khó khăn trong cuộc sống, như mất việc làm, chấn thương, hoặc
          đối mặt với các tình huống khó khăn.
        </p>
          ...
          <div className='fixed bottom-0 left-0 right-0 top-0 m-auto h-[285px] w-[90%] rounded-[10px] bg-white px-5 pt-2 md:h-[336px] md:w-[48%]'>
            ...
            <div className='flex items-end'>
              <div className='flex flex-col justify-center mx-auto mt-4 w-[290px] border-1 border-[#62BAC3] rounded-3xl md:mt-9 md:w-[494px] '>
                <button className='h-14 px-7 py-2 my-2 text-center text-16 font-medium text-black border taiwin hover:bg-[rgba(69,190,229,1)] hover:text-white md:px-0 rounded-2xl border-primary'>
