...
const Header = () => {
  return (
    <>
<<<<<<< HEAD
       <header className='css-bkcare z-[1001] m-auto h-[78px!important] w-full md:w-full bg-white pl-[15px] pr-[15px] md:w-[]768px] md:px-0 flex justify-around  lg:bg-[#EDFFFA] lg:pl-2.5 xl:mt-0 xl:h-[78px] xl:w-full xl:pl-5 xl:pr-0 2xl:w-auto 2xl:px-0'>
=======
...
>>>>>>> master
        ...
        <div className='flex h-[78px] w-full  items-center justify-center lg:w-lg  lg:items-start lg:justify-normal xl:w-[1208px] xl:flex-row xl:items-center xl:self-center 2xl:self-auto'>
          <div className='flex items-center'>
            <button className='css-bkcare cursor-pointer mr-2.5 mt-[5px!important] h-6 w-6 sm:h-[35px] sm:w-[35px]'>
            ...
            <Link to='/' className=' '>
              <img className='w-full h-full' src='https://bookingcare.vn/assets/icon/bookingcare-2020.svg' alt='' />
            </Link>
          </div>
